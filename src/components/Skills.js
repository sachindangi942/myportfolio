...
import { Container, Row, Col, Card } from "react-bootstrap";
import { FaReact, FaNodeJs, FaGitAlt, FaGithub, FaAws, FaMicrosoft } from "react-icons/fa";
import { SiMongodb, SiExpress, SiRedux, SiJavascript, SiPostman, SiDocker, SiHtml5, SiCss3, SiAntdesign, SiMaterialdesign } from "react-icons/si";
...
const skills = [
  ...
  { name: "MongoDB", icon: <SiMongodb size={50} className="text-green" /> },
  { name: "JavaScript", icon: <SiJavascript size={50} className="text-warning" /> },
  { name: "HTML", icon: <SiHtml5 size={50} className="text-danger" /> },
  { name: "CSS", icon: <SiCss3 size={50} className="text-info" /> },
  { name: "React-Bootstrap", icon: <FaReact size={50} className="text-primary" /> }, // You can use a custom icon or the same React icon
  { name: "Ant Design", icon: <SiAntdesign size={50} className="text-blue" /> },
  { name: "Material UI", icon: <SiMaterialdesign size={50} className="text-primary" /> }, // Using SiMaterialdesign as a substitute
];
